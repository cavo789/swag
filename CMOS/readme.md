...
>
> [http://www.retroarchive.org/swag/HARDWARE/0056.PAS.html](http://www.retroarchive.org/swag/HARDWARE/0056.PAS.html)
...
St[75] := '';
St[76] := Line4;
St[77] := '³ Le premier tableau  reprï¿½sente l''"Advanced CMOS Setup".    Ces valeurs sont  ³';
St[78] := '³ essentielles pour un fonctionnement correct de votre ordinateur.             ³';
St[79] := '³                                                                              ³';
St[80] := '³ Conservez toujours cette page prï¿½s de votre ordinateur pour  pouvoir, en cas ³';
St[81] := '³ de besoin, restorer ces donnï¿½es (avec des  donnï¿½es incorrectes, votre  PC ne ³';
St[82] := '³ fonctionnera plus correctement).                                             ³';
St[83] := Line5;
St[84] := '³ Conservez toujours cette page prï¿½s de votre ordinateur pour  pouvoir, en cas ³';
St[85] := '³ de besoin, restorer ces donnï¿½es (avec des  donnï¿½es incorrectes, votre  PC ne ³';
...
St[90] := '³                                                                              ³';
St[91] := '³        Ce programme est distribuï¿½ gratuitement en tant que Cardware.         ³';
